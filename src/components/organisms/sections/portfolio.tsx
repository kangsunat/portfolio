  ...
  return (
    <section className="relative my-10">
      <div className="absolute inset-x-0 bottom-0 grid h-[30%] place-content-center bg-gradient-to-b  from-transparent via-primary to-primary">
        <button
          className="inline-flex  w-fit items-center rounded-full bg-white px-3 py-1 text-black md:px-3 md:py-2"
      ...
      <div className="container space-y-10 p-8 ">
        ...
        <main className="grid h-[80vh] grid-cols-2 gap-4 overflow-hidden md:grid-cols-3 lg:grid-cols-4">
          <PortfolioCard
